    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="请输入图书名" name="name" value="{{$book->name}}">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="请输入图书售价" name="price" value="{{$book->price}}">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form class="upload_pic_wrap" target="upload_file" enctype="multipart/form-data" method="POST" action="/admin/upload/pic">
                        ...
                        <div class="pic-each">
                            <img class="preview_img" src="{{'/storage/' . $book->main_img}}">
                            <div class="hidden image_key">
                                <span data="{{$book->main_img}}"></span>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <textarea   id="editor"  name="summary" style="height: 300px;">{{$book->summary}}</textarea>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="tags" value="{{$book->tags}}">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                <div class="col-lg-4 col-lg-offset-2">
                    ...
                    <button class="btn btn-w-m btn-outline btn-primary save" data="{{$book->id}}">保存</button>
                </div>
            </div>
        </div>
    </div>
