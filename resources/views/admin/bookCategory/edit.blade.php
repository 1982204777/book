...
@section('js')
	<script type="text/javascript" src="/js/web/bookCategory/set.js"></script>
@endsection
@section('content')
	...
	<div class="col-lg-12">
		...
		<div class="form-horizontal m-t m-b">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="weight" class="form-control" placeholder="请输入权重~~" value="{{$category->weight}}">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
				<div class="col-lg-4 col-lg-offset-2">
					...
					<button class="btn btn-w-m btn-outline btn-primary save" data="{{$category->id}}">保存</button>
				</div>
			</div>
		</div>
	</div>
