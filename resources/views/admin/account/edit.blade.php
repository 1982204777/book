        ...
        <div class="col-lg-12">
            ...
            <div class="form-horizontal m-t m-b">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="login_name" class="form-control" autocomplete="off" placeholder="请输入登录名~~" value="{{$user->login_name}}">
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="password" name="login_pwd" class="form-control"  autocomplete="new-password" placeholder="请输入登录密码~~" value="{{$user->login_pwd}}">
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    <div class="col-lg-4 col-lg-offset-2">
                        ...
                        <button class="btn btn-w-m btn-outline btn-primary save" data="{{$user->uid}}">保存</button>
                    </div>
                </div>
            </div>
        </div>
